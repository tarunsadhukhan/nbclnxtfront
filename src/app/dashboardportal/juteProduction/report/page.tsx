...
export default function JuteProductionReportsPage() {
  ...
  useEffect(() => {
    let mounted = true;
    fetchReportMenuTree("juteProduction/report")
      .then((res) => {
        if (!mounted) return;
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Paper elevation={1} sx={{ mb: 3 }}>
        ...
        >
          {/* Searchable report picker — DB-driven (menu_mst report=1, children of the production reports menu). */}
          <Autocomplete
            options={dbReports}
